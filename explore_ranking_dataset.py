...
<section style="background:white;border-radius:10px;padding:20px 24px;margin-bottom:30px;box-shadow:0 1px 4px rgba(0,0,0,0.08);">
  <div style="display:grid;grid-template-columns:repeat(3,1fr);gap:20px;">
    <div style="grid-column:1/-1;font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:0.08em;color:#999;margin-bottom:2px;">How to read this page</div>
    <div><h3 style="font-size:13px;font-weight:700;color:#c87941;margin:0 0 6px">How it was made</h3><p style="font-size:13px;color:#555;line-height:1.7;margin:0">147,555 survey respondents each rated several pairs of characters on a 1–6 scale from "extremely similar" to "extremely different." Those ratings were averaged per pair (minimum 20 ratings for reliability), giving a human-perceived similarity score from 0–100 for 6,713 character pairs.</p></div>
    <div><h3 style="font-size:13px;font-weight:700;color:#c87941;margin:0 0 6px">What you're looking at</h3><p style="font-size:13px;color:#555;line-height:1.7;margin:0">The top charts show which pairs people rated most alike. The scatter plot compares those human ratings against the algorithm's BAP personality distance — if the two agreed perfectly, you'd see a clean downward line. The correlation of 0.07 tells us they mostly disagree. The search tools let you explore any character or pair directly.</p></div>
    <div><h3 style="font-size:13px;font-weight:700;color:#c87941;margin:0 0 6px">How to interpret it</h3><p style="font-size:13px;color:#555;line-height:1.7;margin:0">A high similarity score means many people felt those two characters had the same vibe. Cross-franchise pairs (red bars) are the most surprising — people perceived characters from completely different universes as kindred spirits. The low algorithm correlation suggests human perception picks up on things beyond raw trait scores, like role, narrative arc, or cultural associations.</p></div>
  </div>
</section>
</body>
</html>"""
